...
import {
    ...
    Layer, Layers, Selection, CopyPaste, onCanvasLayer, StandardDragMode
} from "../../js/toolkit.js";
import {
...
import {
    ...
    TextAnchor, definePropertiesSet, filterProperties, Visibility
} from "../../js/graphics.js";
import {
    BoardItemBuilder, ToolCommandPopup, ToolGridExpandablePanel, ToolExpandablePopup, ToolGridPanelContent,
    makeMenuOwner, TextMenuOption, FavoriteItemBuilder, ToolToggleCommand
} from "../../js/tools.js";
import {
    Facilities, normalModeCommand, scrollModeCommand, selectAreaModeCommand, copyCommand, deleteCommand, pasteCommand,
    redoCommand, undoCommand, zoomExtentCommand, zoomInCommand, zoomOutCommand, zoomSelectionCommand,
    regroupCommand, ungroupCommand, lockCommand, unlockCommand, favoritesCommand, layersCommand, showInfosCommand,
    addGroupFacility, addHighlightFacility, addLockFacility, addDeleteFacility
...
const TABLE_LAYERS_DEFINITION = {layers:[DIAMLayers.DOWN,  DIAMLayers.MIDDLE, DIAMLayers.UP, DIAMLayers.PDF]};
...
function makePdfAreasOwner(superClass) {
    ...
    superClass.prototype._insertChild = function(previous, element) {
        console.assert((previous instanceof DIAMPrintArea && element instanceof DIAMPrintArea) ||
